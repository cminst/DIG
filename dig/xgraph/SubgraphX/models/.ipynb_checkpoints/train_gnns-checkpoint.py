...
def train_MUTAG():
    ...
    dataloader = get_dataloader(dataset, train_args.batch_size, data_args.random_split, data_args.data_split_ratio, data_args.seed)
    ...
    # report test msg
    checkpoint = torch.load(os.path.join(ckpt_dir, f'{model_args.model_name}_best.pth'), weights_only=False)
